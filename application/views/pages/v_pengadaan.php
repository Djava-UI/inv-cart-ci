...
<!--================ Content Wrapper===========================================-->
<div class="well">
    <a href="<?php echo site_url('pengadaan/pages_tambah_pengadaan')?>" class="btn btn-large btn-block btn-inverse" data-toggle="modal">
    ...
    if(isset($data_pengadaan)){
        foreach($data_pengadaan as $row){
            ...
            <tr class="gradeX">
                ...
                <td>
                    <a class="btn btn-mini btn-block btn-danger" href="<?php echo site_url('pengadaan/hapus/'.$row->kd_pengadaan)?>"
